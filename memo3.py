...
# Path to the Wikipedia dump (XML file)
...
# List to store tokenized articles that mention "Aplpe" or "BlackBerry"
tokenized_corpus = []

# Process the corpus and filter articles based on the keywords
